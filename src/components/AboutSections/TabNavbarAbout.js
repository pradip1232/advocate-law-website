                ...
                <CustomTabPanel value={value} index={2}>
                    <Container>
                        <Grid container spacing={2}>
                            ...
                            <p className='tab-navbar-aboutus'>Choosing Khapra Law Firm means partnering with a  dedicated team that puts your interests first. Let us guide you  through your legal journey with confidence and expertise.  Contact us today to learn more about how we can assist you!</p>
                        </Grid>
                        <hr />
                    </Container>
                </CustomTabPanel>
