            ...
            <Container className='about-pages-text-cont'>
                ...
                <Row>
                    <div className="col-md-12 text-center">
                        ...
                        <Typography
                            variant='h6'>
                            At Khapra Law Firm, we believe that every legal challenge is an opportunity for resolution, justice, and growth. Since our establishment, we have been dedicated to providing expert legal services with a focus on personalized client care.
                        </Typography>
